...
def create_fasta(key, values, genome, arabid_ref, fasta_stash): 
    name = str(key) + 'FullContig.fasta'
...
def main():
    ...
    for cluster in clusters:
        filenames.append( create_fasta(cluster, clusters[cluster], genome, reference, fasta_stash) )
    ...
    with open('/home/justinz/scratch/Cooke/blast/data/ClusterNumbersContig', 'wb') as handle:
